        ...
        LazyColumn(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Switch(
                            ...
                            onCheckedChange = { newTask = newTask.copy(isAllDay = it) }
                        )
                    }
                    ...
                    if (!newTask.isAllDay) {
                        Row(
                            ...
                            OutlinedButton(
                                ...
                                Text(text = newTask.startTime?.toFormattedString(is24Hr) ?: "Start Time")
                            }
                            ...
                            OutlinedButton(
                                ...
                                Text(text = newTask.endTime?.toFormattedString(is24Hr) ?: "End Time")
                            }
                        }
                        ...
                        DurationSelector(
                             selectedDuration = newTask.getDurationMinutes(),
                             onDurationSelected = { duration ->
                                 val start = newTask.startTime ?: LocalTime(9, 0) // Default start if null
                                 val startMinutes = start.hour * 60 + start.minute
                                 val endMinutes = startMinutes + duration
                                 
                                 val endHour = (endMinutes / 60) % 24
                                 val endMinute = endMinutes % 60
                                 
                                 val newEndTime = LocalTime(endHour.toInt(), endMinute.toInt())
                                 
                                 newTask = newTask.copy(
                                     startTime = if(newTask.startTime == null) start else newTask.startTime,
                                     endTime = newEndTime
                                 )
                             },
                             modifier = Modifier.fillMaxWidth()
            ...
            item {
                Column(
                    ...
                    Row(
                        ...
                        Switch(
                            checked = newTask.isRepeated,
                            onCheckedChange = { newTask = newTask.copy(isRepeated = it) }
                        )
                    }

                    if (newTask.isRepeated) {
                        WeekDaysComponent(
                            selectedDays = newTask.repeatWeekdays,
                            onDaySelected = { newTask = newTask.copy(repeatWeekdays = it) },
            ...
            item {
                PrioritySelector(
                    ...
                    onPrioritySelected = { newTask = newTask.copy(priority = it) },
